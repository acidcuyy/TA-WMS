              ...
              <svg width="100%" height="100%" viewBox="0 0 800 200" preserveAspectRatio="none" className="svg-chart">
                <defs>
                  ...
                  <linearGradient id="gradPO" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#fa8c16" stopOpacity="0.2" />
                ...
                <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 1.5 }}>
                  ...
                  {/* PO Points */}
                  <circle cx="100" cy="160" r="4.5" fill="var(--bg)" stroke="#fa8c16" strokeWidth="2" />
                  <circle cx="200" cy="170" r="4.5" fill="var(--bg)" stroke="#fa8c16" strokeWidth="2" />
                  <circle cx="300" cy="150" r="4.5" fill="var(--bg)" stroke="#fa8c16" strokeWidth="2" />
                  <circle cx="400" cy="170" r="4.5" fill="var(--bg)" stroke="#fa8c16" strokeWidth="2" />
                  <circle cx="500" cy="160" r="4.5" fill="var(--bg)" stroke="#fa8c16" strokeWidth="2" />
                  <circle cx="600" cy="180" r="4.5" fill="var(--bg)" stroke="#fa8c16" strokeWidth="2" />
                  <circle cx="700" cy="160" r="4.5" fill="var(--bg)" stroke="#fa8c16" strokeWidth="2" />
