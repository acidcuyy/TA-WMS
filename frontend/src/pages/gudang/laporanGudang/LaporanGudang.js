...
export default function LaporanGudang() {
  ...
  const summaryCards = [
    ...
    { label: "Barang Keluar", value: "12,500", unit: "unit", icon: "📈", iconClass: "summary-card__icon--green" },
    { label: "Barang Masuk", value: "15,200", unit: "unit", icon: "📥", iconClass: "summary-card__icon--blue" },
    { label: "Retur", value: "180", unit: "unit", icon: "↩", iconClass: "summary-card__icon--red" },
    { label: "Penyesuaian Stok", value: "64", unit: "transaksi", icon: "⚖", iconClass: "summary-card__icon--orange" },
  ];
  ...
  const handleUploadSubmit = () => {
    ...
    setReports(prev => [
      { id: `RPT-GDG-${Math.floor(Math.random()*900)+100}`, type: form.type, author: "Admin Gudang", format: "PDF", formatColor: "#ef4444", status: "Selesai" },
      ...prev
    ]);
  ...
  return (
    <div className="laporan-gudang">
      ...
      >
        {/* HEADER */}
        <header className="laporan-gudang__header">
          <div className="laporan-gudang__title-section">
            <h1>Laporan Gudang</h1>
            <p>Ringkasan laporan operasional gudang, inbound, outbound, retur, dan aktivitas lainnya.</p>
          </div>
        ...
        {/* SUMMARY */}
        <section className="laporan-gudang__summary">
        ...
        {/* FILTERS */}
        <section className="laporan-filters">
          <select className="filter-select"><option>Semua Jenis Laporan</option></select>
          <input type="text" className="filter-date" placeholder="01 Mei 2026 - 24 Mei 2026" />
        ...
        <section className="performance-chart-card">
          <div className="chart-header">
            <h3 className="chart-title">Ringkasan Pergerakan Barang</h3>
            <div className="chart-actions-group">
              <div className="chart-legend">
                <div className="legend-item"><span className="legend-dot" style={{ background: "#f97316" }}></span> Outbound</div>
                <div className="legend-item"><span className="legend-dot" style={{ background: "#3b82f6" }}></span> Inbound</div>
        ...
        {/* MAIN GRID */}
        <div className="laporan-gudang__main">
          {/* LEFT CONTENT */}
          <section className="laporan-content-box">
          ...
          {/* RIGHT SIDEBAR */}
          <aside className="laporan-sidebar">
            <div className="sidebar-widget">
              <h3 className="widget-title">Jenis Laporan</h3>
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                {[
                  { icon: "📤", label: "Outbound", val: "12" },
                  { icon: "📦", label: "Stok Gudang", val: "6" },
                  { icon: "📥", label: "Inbound", val: "4" },
                  { icon: "🔄", label: "Transfer", val: "3" },
            ...
            <div className="sidebar-widget">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                {[
                  { color: "#f97316", label: "Outbound", val: "12 (37,5%)" },
                  { color: "#3b82f6", label: "Stok", val: "6 (18,8%)" },
                  { color: "#22c55e", label: "Inbound", val: "6 (18,8%)" },
              ...
              <div className="activity-list">
                <div className="activity-item">
                  ...
                  <div className="activity-content">
                    <span className="activity-name">Laporan Outbound 20-24 Mei 2026 dibuat</span>
                    <span className="activity-sub">oleh Admin Gudang • 10:30 WIB</span>
                  </div>
                </div>
                <div className="activity-item">
            ...
            <div className="sidebar-widget">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "11px" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <span style={{ display: "block", fontWeight: 600 }}>Laporan Outbound Harian</span>
                    <span style={{ color: "#94a3b8" }}>25 Mei 2026, 18:00</span>
                  </div>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "11px" }}>
                  <span style={{ fontSize: "16px" }}>📅</span>
                  <div style={{ flex: 1 }}>
                    ...
                    <span style={{ color: "#94a3b8" }}>26 Mei 2026, 08:00</span>
                  </div>
                </div>
              </div>
      ...
      <AnimatePresence>
        {openModal && (
          <div className="lg-modal-overlay" onClick={() => setOpenModal(false)}>
            <motion.div 
              className="lg-modal"
            ...
            >
              ...
              <div className="lg-modal-body">
                ...
                <div className="lg-form-group">
                  ...
                  <select value={form.type} onChange={(e) => setForm({...form, type: e.target.value})}>
                    ...
                    <option value="Laporan Outbound">Laporan Outbound</option>
                    <option value="Laporan Inbound">Laporan Inbound</option>
                ...
                <div className="lg-form-group">
                  ...
                  <label className="lg-file-upload">
              ...
              <div className="lg-modal-footer">
                <button className="lg-btn-ghost" onClick={() => setOpenModal(false)}>Batal</button>
                <button className="lg-btn-primary" onClick={handleUploadSubmit}>Upload Arsip</button>
              </div>
            </motion.div>
          </div>
        )}
